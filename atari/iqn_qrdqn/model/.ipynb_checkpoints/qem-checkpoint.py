...
class QCM(BaseModel):
    ...
    def __init__(self, num_channels, num_actions, qcm_weight,N=200, embedding_dim=7*7*64,
    ...
    def calculate_q(self, states=None, state_embeddings=None):
        ...
        q = torch.matmul(self.qcm_weight,quantiles)[:,:2,:]     #(batch_size, 4, self.num_actions)
