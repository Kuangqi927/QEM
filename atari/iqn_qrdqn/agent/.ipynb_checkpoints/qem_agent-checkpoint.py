...
from fqf_iqn_qrdqn.model import QCM
from fqf_iqn_qrdqn.utils import calculate_quantile_huber_loss, disable_gradients, evaluate_quantile_at_action, update_params,calculate_qcm,LinearAnneaer
...
class QCMAgent(BaseAgent):
    ...
    def __init__(self, env, test_env, log_dir, explo,algo,num_steps=5*(10**7),
        ...
        # N*N size
        self.qcm_weight = calculate_qcm(self.tau_hats,self.V).to(self.device)
        self.N = N
        ...
        self.online_net = QCM(
            ...
            qcm_weight=self.qcm_weight, N=N, dueling_net=dueling_net,
