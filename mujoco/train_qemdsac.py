...
from rlkit.torch.qemdsac.qemdsac import QEMDSACTrainer
...
if __name__ == "__main__":
    ...
    parser.add_argument('--config', type=str, default="configs/dsac-normal-fix-neutral/ant.yaml")
    ...
    variant["trainer_kwargs"]["weight"] = args.weight

    log_prefix = "_".join(["qemdsac-weight-%s"%args.weight, variant["env"][:-3].lower(), str(variant["version"])])
